...
##4 1. What are the Data that you are looking at? The Data in the .xlsx-file shows different measurements of ambient CO2 and increased CO2 for different experiments. The data also repetitions of each experiments once or several times over the years. This helps to see what changed over time (years).
