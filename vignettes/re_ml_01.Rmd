...
k_values <- 1:250 # this step takes very long because there are some "Warnungen: Non positiv values in selected variable" and "No Box-Cox transformation could be estimated for TA_F

# Loading function which takes k and calculates mae-
source("../R/k_to_mae.R")

mae_values <- sapply(k_values, fit_and_eval_knn, df = daily_fluxes) #determining MAE-value for each k (1 to lenngt of rows und daily fluxes)
